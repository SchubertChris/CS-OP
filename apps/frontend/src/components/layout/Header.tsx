    ...
    <>
      ...
      <div className="fixed right-0 top-[30%] z-40 lg:hidden flex items-center">
        ...
        <button
          ...
          className="w-5 h-10 flex items-center justify-center bg-[#0d0d0d]/90 border border-[#C9A84C]/20 border-r-0 rounded-l-lg text-[#C9A84C]/60 hover:text-[#C9A84C] transition-colors duration-200 shrink-0"
        >
          <ChevronRight
        ...
        <div
          className="flex flex-col items-center gap-1 py-3 px-1.5 bg-[#0d0d0d]/90 backdrop-blur-xl border border-[#C9A84C]/15 rounded-l-2xl overflow-hidden transition-all duration-300"
