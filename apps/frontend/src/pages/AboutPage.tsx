...
const CONTACTS = [
  ...
  { icon: <MessageSquare size={20} strokeWidth={1.5} />, title: 'Discord', value: 'Community Server', href: 'https://discord.gg/', desc: 'Community & schneller Austausch.', external: true },
]
